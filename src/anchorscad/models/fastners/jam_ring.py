...
class JamRingPathBuilder:
    ...
    rs: float=ad.dtfield(7.8 / 2, doc='Randius of the small end (base)')
    rl: float=ad.dtfield(8.2 / 2, doc='Randius of the large end (top)')
    ro: float=ad.dtfield(14 / 2, doc='Randius of the outer surface')
